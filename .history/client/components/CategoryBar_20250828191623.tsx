      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center overflow-x-auto scrollbar-hide py-3 space-x-6">
          {categories.map((category) => (
            ...
            >
              {/* Category Button */}
              <button className="flex items-center space-x-2 px-4 py-2 text-gray-700 hover:text-pink-600 hover:bg-pink-50 rounded-lg transition-all duration-200 whitespace-nowrap group">
        ...
        {hoveredCategory && (categoryHovered || dropdownHovered) && (
          <div
            className="w-full bg-white shadow-xl rounded-lg border border-gray-200 mt-1 animate-in slide-in-from-top duration-200"
          ...
          >
            <div className="py-2">
              <div className="px-3 py-2 text-sm font-semibold text-gray-500 border-b border-gray-100">
                {categories.find(c => c.category_id === hoveredCategory)?.category_name}
              </div>
