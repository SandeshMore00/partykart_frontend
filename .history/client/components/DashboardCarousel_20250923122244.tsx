...
const DASHBOARD_IMAGE_API = `${config.PRODUCTS_SERVICE_URL}/v1/products/dashboard-image/`;
...
const DashboardCarousel: React.FC = () => {
  ...
  const handleUploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${config.PRODUCTS_SERVICE_URL}/v1/products/dashboard-image`, {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="relative w-full max-w-3xl mx-auto aspect-[16/7] rounded-lg overflow-hidden shadow-lg">
      ...
      {/* Admin Controls */}
      {/* ⬇️ CHANGE 2: check for both admin and super admin */}
