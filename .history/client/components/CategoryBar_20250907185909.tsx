        ...
        <div className="flex items-center overflow-x-auto scrollbar-hide py-3 space-x-6">
          {categories.map((category) => (
            ...
            >
              {/* Category Button */}
              <button
                className={`flex items-center space-x-2 px-4 py-2 text-gray-700 hover:text-pink-600 hover:bg-pink-50 rounded-lg transition-all duration-200 whitespace-nowrap group ${activeCategory === category.category_id ? 'bg-pink-100 text-pink-600' : ''}`}
