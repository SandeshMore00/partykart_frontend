...
const Orders: React.FC = () => {
  ...
  const token =
    "YOUR_BEARER_TOKEN_HERE"; // Replace with real JWT from login

  // Decode user role from JWT (simplified)
  ...
  // Fetch ALL orders (only for admin/super admin)
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {loading ? (
        ...
        <div>
          ...
          {/* Only show button for admin/super admin */}
          {user &&
