...
export default function AdminDashboard() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // Fetch categories
      const categoriesResponse = await fetch(config.CATEGORY_SERVICE_URL + '/v1/category', { headers });
  ...
  const handleCreateCategory = async () => {
    ...
    try {
      ...
      const response = await fetch(config.CATEGORY_SERVICE_URL + '/v1/category/create', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${user?.token}`
        },
  ...
  const handleDeleteCategory = async (categoryId: number) => {
    ...
    setCategorySuccess('');
    try {
      const response = await fetch(config.CATEGORY_SERVICE_URL + `/v1/category/delete/${categoryId}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${user?.token}`
        }
  ...
  const handleUpdateCategory = async () => {
    ...
    try {
      ...
      const formData = new FormData();
      formData.append('category_name', categoryForm.category_name);
      const response = await fetch(config.CATEGORY_SERVICE_URL + `/v1/category/update/${editingCategory?.category_id}`, {
        method: 'PATCH',
        headers: {
          'Authorization': `Bearer ${user?.token}`
        },
  ...
  const handleCreateSubcategory = async () => {
    ...
    try {
      const headers = { 'Authorization': `Bearer ${user?.token}` };
      const subcategoriesResponse = await fetch(config.CATEGORY_SERVICE_URL + '/v1/category/sub-category/', { headers });
  ...
  const handleDeleteSubcategory = async (subCategoryId: number) => {
    ...
    try {
      const response = await fetch(config.CATEGORY_SERVICE_URL + `/v1/category/sub-category/delete/${subCategoryId}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${user?.token}`
        }
  ...
  const handleUpdateSubcategory = async () => {
    ...
    try {
      ...
      formData.append('sub_category_name', subcategoryForm.sub_category_name);
      formData.append('category_id', subcategoryForm.category_id);
      const response = await fetch(config.CATEGORY_SERVICE_URL + `/v1/category/sub-category/update/${editingSubcategory?.sub_category_id}`, {
        method: 'PATCH',
        headers: {
          'Authorization': `Bearer ${user?.token}`
        },
