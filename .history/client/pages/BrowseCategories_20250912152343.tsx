...
const BrowseCategories: React.FC = () => {
        ...
        {categories.map((category) => {
          ...
          return (
            <div
              ...
              onClick={() => {
                navigate(`/products/subcategory/${category.category_id}?type=category&name=${encodeURIComponent(category.category_name)}`);
              }}
            >
                  ...
                  <div className="flex flex-col gap-1">
                    {subcategories.map((subcategory) => (
                      <button
                        ...
                        onClick={e => {
                          e.stopPropagation();
                          navigate(`/products/subcategory/${subcategory.sub_category_id}?type=subcategory&name=${encodeURIComponent(subcategory.sub_category_name)}`);
                        }}
  ...
  {/* Products Grid removed: navigation now redirects to product listing page */}
    </div>
  );
};
