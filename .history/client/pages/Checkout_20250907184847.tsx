...
export default function Checkout() {
  ...
  const [appliedOffer, setAppliedOffer] = useState(null as null | { offer_id: number; offer_name: string; offer_percentage: number });
  ...
  const offerAmount = appliedOffer ? Math.round(getTotalPrice() * (appliedOffer.offer_percentage / 100)) : 0;
                  ...
                  <div className="container mx-auto px-4 py-8 max-w-2xl">
                    ...
                    {step === 4 && (
                      <div className="text-center py-8">
                        ...
                        {orderId && (
                          <p className="text-lg font-bold text-gray-700 mb-2">Order ID: {orderId}</p>
                        )}
                        <p className="text-gray-600 mb-6">Thank you for your order. You will receive a confirmation shortly.</p>
