          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mt-6">
              ...
              <ul className="space-y-2 text-blue-700 font-medium">
                <li><a href="/policy/privacy" className="hover:underline">Privacy Policy</a></li>
                <li><a href="/policy/terms" className="hover:underline">Terms of Service</a></li>
                <li><a href="/policy/refund" className="hover:underline">Refund Policy</a></li>
                <li><a href="/policy/shipping" className="hover:underline">Shipping Policy</a></li>
              </ul>
            </div>
